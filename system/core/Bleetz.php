...
final class Bleetz {
	...
	public static function start() {
		...
		//� d�finir dans les services des auto configs...
		Bleetz::load_services(CFG::$services);

		//pour l'instant, par la suite on peut d�finr des fonctions init pour nos trucs....
		...
		echo $postdata;
		*/
		// Recuperation des donnees post�es
		$sys_form_vars=array();
		if ($_GET) {
		...
		//Bleetz::$content appell� a disparaitre
