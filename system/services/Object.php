...
class Object  {
  ...
  function InitId($obj_id) {
	...
	/**
	 * Cr�er une nouvel objet et l'ajoute �  la base de donn�e
	 * 
  ...
  /**
   * Charge un objet � partir de la base de donn�e
   *
...
class SET {
	...
	/**
	 * Charge un objet de type ressource � partir de la base de donn�e
	 ...
	 *
	 * @param  $rsc_id : id de l'objet
	 * @param  $data : donn�es � sauver
	 * @param  $size : taille des donn�es � sauver
	 *
	 * @return  bool
	 */
