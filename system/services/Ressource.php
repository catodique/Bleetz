...
class Ressource {
	...
	/**
	 * Créer une nouvelle ressource et l'ajoute à  la base de donnée
	 * 
  ...
  function Clean( $deletefile=false ) {
   ...
   /**
    * Enregistre les données $text dans la ressource
    * dans la langue specifiée
    *
   ...
   /**
	...
	function StoreString($data, $lang="fr_FR") {
	  ...
	  /**
	   * Rattache le chemin fichier à un objet
	   *
...
class RS {
	...
	/**
	 * Créer une instance de ressource après l'avoir ajoutée a la base de donnée
	 *
	 * @param  obj_id : id de l'objet
	...
	/**
	 * Charge une information si elle existe, la créée sinon
	 *
	 * @param  obj_id : id de l'objet
	 *
